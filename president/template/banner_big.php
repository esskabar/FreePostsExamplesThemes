...
<div class="top_block_big">
    ...
    if ( $query_main_top_big->have_posts() ) {
        while ( $query_main_top_big->have_posts() ) {
            ...
            if ( has_post_thumbnail()){
                $thumb_ = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'president-theme-main-top_big-thumbnail' );
            } else {
                $thumb_ = array();
            }
            ?>
    ...
    <article>
        <a href="<?php the_permalink(); ?>" class="wrapp_item">
            ...
            <div class="item_text">
                <p class="meta_categoty yellow"><?php echo $c[0]->cat_name; ?></span></p>
