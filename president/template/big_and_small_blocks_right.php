...
$main_top_post_id = get_option('block_main_four_posts');
$post_in = $main_top_post_id ? $main_top_post_id['right_big'] : '';
?>
...
<div class="tpb_item">
    ...
    global $post_not_in;
    $post_not_in = !empty( $post_not_in ) ? $post_not_in : array();
    $three_posts_block_id = get_option('block_main_four_posts');
    if ( !empty($three_posts_block_id['right_small']) ){
        $post_in = explode(',', $three_posts_block_id['right_small']);
    } else {
        $post_in = '';
    }
