...
$post_in = $main_top_post_id ? $main_top_post_id['left_first'] : '';
?>
...
<div class="top_block_right">
    ...
    <article>
        <a href="<?php the_permalink(); ?>" class="wrapp_item">
            ...
            <div class="item_text">
                <p class="meta_categoty red"><?php echo $c[0]->cat_name; ?></span></p>
    ...
    $post_not_in = !empty( $post_not_in ) ? $post_not_in : array();
    $main_top_post_id = get_option('main_top_post_id');
    $post_in = $main_top_post_id ? $main_top_post_id['left_second'] : '';
    ?>
    <?php
    ...
    <article>
        <a href="<?php the_permalink(); ?>" class="wrapp_item">
            ...
            <div class="item_text">
                <p class="meta_categoty blue"><?php echo $c[0]->cat_name; ?></span></p>
                <h2 class="header_item"><?php the_title();?></h2>
