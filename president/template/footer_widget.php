...
$three_posts_block_id = get_option('block_footer_posts_right');
if ( !empty($three_posts_block_id['top']) ){
    $post_in = explode(',', $three_posts_block_id['top']);
} else {
    $post_in = '';
}

?>
<div class="col-xs-12 col-sm-12 col-md-12 footer_widget equal_footer hidden-xs">
    <?php
    ...
    <div class="aside-popular small_block">
        <div><h2 class="popular_post_head widget-title">Tranding Now</h2></div>
        <div class="widget">
            <?php
