...
<div class="three_blocks_item three_blocks_item_center clearfix">
    ...
    if ( has_post_thumbnail()){
        $thumb_ = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'hyperactivz-theme-main_three-center-thumbnail' );
    } else {
        $thumb_ = array();
    }?>
    <?php
    ...
    <?php get_template_part( 'template/three_blocks_center_big' ) ?>
