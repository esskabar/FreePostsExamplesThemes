...
if ( ! function_exists( 'hyperactivz_setup' ) ) :
    function hyperactivz_setup() {
        ...
        add_image_size( 'hyperactivz-theme-main-thumbnail', 288, 310, true );
        add_image_size( 'hyperactivz-theme-main-aside-thumbnail', 255, 120, true );
        add_image_size( 'hyperactivz-theme-main_wide-thumbnail', 362, 200, true );
        add_image_size( 'hyperactivz-theme-main-top_big-thumbnail', 581, 310, true );
        add_image_size( 'hyperactivz-theme-main_small-thumbnail', 93, 68, true );
        add_image_size( 'hyperactivz-theme-main_three-center-thumbnail', 170, 120, true );
...
function hyperactivz_menu() {
    ...
    add_theme_page('Center and Three Posts block ', 'Center and Three Posts block', 'edit_theme_options', 'hyperactivz-options-three-posts-block', 'hyperactivz_options_three_posts_block');
    add_theme_page('Four block left', 'Four block left', 'edit_theme_options', 'hyperactivz-options-three-post', 'hyperactivz_options_three_post');
    add_theme_page('Two right post', 'Two right post', 'edit_theme_options', 'hyperactivz-options-wide-post', 'hyperactivz_options_wide_post');
    add_theme_page('Main 6 posts', 'Main 6 posts', 'edit_theme_options', 'hyperactivz-main-six-posts', 'hyperactivz_main_six');
    add_theme_page('Footer posts', 'Footer posts', 'edit_theme_options', 'hyperactivz-footer-posts', 'hyperactivz_footer_post');
}
...
function plugin_settings_main_top(){
    ...
    add_settings_field('main_top_post_right_first', 'Show post on main top<br>Right Block (left position): (paste ID)', 'fill_main_top_right', 'main_top_block', 'main_top_section_id' );

    add_settings_field('main_top_post_right_second', 'Show post on main top<br>Right Block (right position): (paste ID)', 'fill_main_top_right_second', 'main_top_block', 'main_top_section_id' );
...
function fill_main_top_right(){
    ...
    $val = $val['right_first'];
    ?>
    <input type="text" name="main_top_post_id[right_first]" value="<?php echo esc_attr( $val ) ?>" />
<?php
}
function fill_main_top_right_second(){
    $val = get_option('main_top_post_id');
    $val = $val['right_second'];
    ?>
    <input type="text" name="main_top_post_id[right_second]" value="<?php echo esc_attr( $val ) ?>" />
<?php
}
...
function plugin_settings_three_posts_block(){
    ...
    add_settings_field('three_posts_block_big', 'Show big center posts:<br>', 'fill_big_post_input', 'hyperactivz-options-three-posts-block', 'three_posts_block_section' );
...
function fill_big_post_input(){
    ...
    $val = $val['big_center'];
    ?>
    <input type="text" name="three_posts_block_center[big_center]" value="<?php echo esc_attr( $val ) ?>" />
<?php
}
...
function plugin_settings_three_post(){
    ...
    add_settings_section( 'four_post_section', 'Customize Block with three section', '', 'hyperactivz-options-three-post' );


    add_settings_field('four_post_left', 'Show post in left section:<br>(paste post ID', 'fill_four_post_input_left', 'hyperactivz-options-three-post', 'four_post_section' );
...
function fill_four_post_input_left(){
    ...
    $val = $val['left'];
    ?>
    <input type="text" name="four_post_id[left]" value="<?php echo esc_attr( $val ) ?>" />
<?php
}
...
function plugin_settings_wide_post(){
    ...
    add_settings_field('two_post_wide_right', 'Show post in wide section<br>ONE WIDE: (paste ID)', 'fill_two_wide_post_id', 'hyperactivz-options-wide-post', 'block_wide_post_section' );
...
//block with main six posts
function hyperactivz_main_six() {
    if (!current_user_can('manage_options')) {
        wp_die(__('You do not have sufficient permissions to access this page.'));
    }
    ?>
    <div class="wrap">
        ...
        <form action="options.php" method="POST">
            <?php
            settings_fields( 'block_with_main_six_posts' );
            do_settings_sections( 'hyperactivz-main-six-posts' );
            submit_button();
            ?>
        </form>
    </div>
...
function plugin_settings_main_six_post(){
    ...
    register_setting( 'block_with_main_six_posts', 'block_main_six_posts', 'sanitize_callback' );

    add_settings_section( 'block_main_six_section', 'Customize block main six posts', '', 'hyperactivz-main-six-posts' );

    add_settings_field('two_post_wide_right', 'Show post in wide section<br>ONE WIDE: (paste ID)', 'fill_main_six_post_id', 'hyperactivz-main-six-posts', 'block_main_six_section' );

}
function fill_main_six_post_id(){
    $val = get_option('block_main_six_posts');
    $val = $val['left'];
    ?>
    <input type="text" name="block_main_six_posts[left]" value="<?php echo esc_attr( $val ) ?>" />
<?php
}
...
////Footer posts
function hyperactivz_footer_post() {
    if (!current_user_can('manage_options')) {
        wp_die(__('You do not have sufficient permissions to access this page.'));
    }
    ?>
    <div class="wrap">
        ...
        <form action="options.php" method="POST">
            ...
            do_settings_sections( 'hyperactivz-footer-posts' );
            submit_button();
            ?>
        </form>
    </div>
...
function plugin_settings_footer_post(){
    ...
    add_settings_section( 'block_footer_section', 'Customize block footer posts', '', 'hyperactivz-footer-posts' );

    add_settings_field('footer_posts', 'Show post in wide section<br>ONE WIDE: (paste ID)', 'fill_footer_post_id', 'hyperactivz-footer-posts', 'block_footer_section' );
...
function fill_footer_post_id(){
    ...
    $val = $val['right'];
    ?>
    <input type="text" name="block_footer_posts_right[right]" value="<?php echo esc_attr( $val ) ?>" />
<?php
}
